...
(function ($) {
    ...
    function initLeftSidebar() {
        ...
        // Verifica se existe algum elemento com a classe "side-nav"
        if ($(".side-nav").length) {
            var navCollapse = $('.side-nav li .collapse');
            var navToggle = $(".side-nav li [data-bs-toggle='collapse']");

            // Previne o comportamento padrão do clique nos toggles do menu
            ...
            // Ativa o menu na barra lateral esquerda com base na URL
            $(".side-nav a").each(function () {
                ...
                if (this.href == pageUrl) {
                    ...
                    $(this).parent().parent().parent().parent().addClass("menuitem-active"); // adiciona ativo ao li do link atual
            ...
            // Após um pequeno atraso, rola a barra lateral para o item ativo
            setTimeout(function () {
            ...
            // Função para rolar o elemento até a posição desejada
            ...
            menuToggleBtn.addEventListener('click', function () {
                ...
                if (size === 'full') {
                    ...
                    if (configSize == 'fullscreen') {
                        if (size === 'fullscreen') {
                            self.changeLeftbarSize('condensed', false); // Sempre alterna para 'condensed'
                        } else {
                            self.changeLeftbarSize('fullscreen', false); // Alterna para 'fullscreen'
                        }
                    } else {
                        self.changeLeftbarSize('default', false); // Alterna para 'default'
                    }
                }
