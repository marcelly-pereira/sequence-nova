  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/baseLayout" element={<BaseLayout />}></Route>

        <Route path="/sequencia" element={<MySequences />} />

        <Route path="/templates" element={<TemplatesSequencia />} />

        <Route path="/tarefas" element={<Lists />} />

        <Route path="/detalhes_tarefas" element={<Recurrent />} />

        <Route path="/empresas" element={<Companies />} />

        <Route path="/configurações" element={<Registrations />} />

        <Route path="/lista-automacoes" element={<Automations />} />
        ...
        <Route path="/draggable-card" element={<DraggableCard />} />
